...
const position_schema_1 = require("../../positions/schemas/position.schema");
...
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.default.Schema.Types.ObjectId, ref: position_schema_1.Position.name }),
    __metadata("design:type", mongoose_2.default.Schema.Types.ObjectId)
