...
let BlockchainController = class BlockchainController {
    ...
    async addEmployee(employeeData, employeeId) {
        const txHash = await this.blockchainService.addEmployee(employeeData, employeeId);
        return { success: true, transactionHash: txHash };
    }
    async updateEmployee(employeeData) {
        const txHash = await this.blockchainService.updateEmployee(employeeData, employeeData.employeeId);
        return { success: true, transactionHash: txHash };
    }
